<template>
	<view class='details'>
		...
		<!--商品详情图-->
		<view>
			<view><image class='details-img' src="../../static/imgs/detail1.jpg" mode=""></image></view>
			<view><image class='details-img' src="../../static/imgs/detail2.jpg" mode=""></image></view>
			<view><image class='details-img' src="../../static/imgs/detail3.jpg" mode=""></image></view>
			<view><image class='details-img' src="../../static/imgs/detail4.jpg" mode=""></image></view>
			<view><image class='details-img' src="../../static/imgs/detail5.jpg" mode=""></image></view>
		</view>
		<!--商品列表-->
		...
		data() {
			return {
				...
				swiperList:[
					...
					{imgUrl:"../../static/imgs/details3.jpeg"}
				],
				dataList:[
					{
						id:1,
